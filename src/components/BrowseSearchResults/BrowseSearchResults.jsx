        ...
        <section>
          {type === "movie" ? (
            <section>
              ...
              >
                <h1>
                  {tmdbDetailsReducer.title} (
                  {tmdbDetailsReducer.release_date.substring(0, 4)})
                </h1>
                <CardMedia
                  style={{
                    maxHeight: "20%",
                  ...
                  src={
                    tmdbDetailsReducer.poster_path === null ||
                    configObject === "empty"
                      ? "images/noImage.jpeg"
                      : `${configObject.images.base_url}${configObject.images.poster_sizes[4]}${tmdbDetailsReducer.poster_path}`
                  }
                  title={tmdbDetailsReducer.title}
                />
                <p>
                  <b>Length:</b> {tmdbDetailsReducer.runtime} mins
                </p>
                <p>
                  <b>Overview: </b>
                  {tmdbDetailsReducer.overview}
                </p>
                <p>
                  <b>IMDB page:</b>{" "}
                  <a
                    href={`https://www.imdb.com/title/${tmdbDetailsReducer.imdb_id}`}
                  >{`https://www.imdb.com/title/${tmdbDetailsReducer.imdb_id}`}</a>
                </p>
                  ...
                  <div>
                    ...
                    <Button
                      disabled={
                        ...
                        tmdbDetailsReducer.credits.cast.length
                      }
                      label="next"
                      onClick={() => setCarousel(carousel + 1)}
                    >
                ...
                <div>
                  <div>
                    ...
                    <Button
                      disabled={
                        (carousel + 1) * pagination >=
                        tmdbDetailsReducer.credits.crew.length
                      }
                      label="next"
                      onClick={() => setCarousel(carousel + 1)}
                    >
