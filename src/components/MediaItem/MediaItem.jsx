...
function MediaItem() {
  ...
  const mediaItemDetailsReducer = useSelector(
    (store) => store.mediaItemDetailsReducer
  );
    ...
    <Grid item style={{ height: "100%", width: "100%", padding: "20px 10px" }}>
      {mediaItemDetailsReducer === "empty" ? (
        ...
        <section>
          ...
          <p>
            <a href={`${mediaItemDetailsReducer.mediaDetails.product_page}`}>
              Product page
            </a>
          </p>
          ...
          <FormControl className={classes.formControl}>
            ...
            >
              ...
              <MenuItem value={mediaItemDetailsReducer.sqlMovieData.length}>
                All
              </MenuItem>
            </Select>
          </FormControl>
          <div>
            ...
            <Button
              disabled={
                ...
                mediaItemDetailsReducer.sqlMovieData.length
              }
              label="next"
              onClick={() => setCarousel(carousel + 1)}
            >
          ...
          >
            {mediaItemDetailsReducer.sqlMovieData
          ...
          <ul>
            {mediaItemDetailsReducer.mediaSpecialFeatures.map(
              (element, index) => {
